...
## Metas e perfil
- Biotipo ectomorfo; meta de **80 kg de massa magra**.
- Framework **VSM / Adonis Index**: proporção ombro/cintura ~1.618, baixa adiposidade.
- Motivação: ter um corpo capaz que dê autoestima para evoluir nas áreas importantes da vida, e um VSM ("valor sexual de mercado") bem ajustado — para me sentir bem comigo mesmo e agradar a Bia.
- **TODO:** registrar peso, altura e % de gordura atuais (necessário para medir progresso rumo aos 80 kg).
...
- Supino reto na máquina — 3x 8–12
- Desenvolvimento halteres sentado — 3x 8–10
- Elevação lateral polia unilateral — 4x 12–20
