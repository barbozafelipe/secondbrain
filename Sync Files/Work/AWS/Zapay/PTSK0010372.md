...
ajustar primeiro no sailpojt, quando aparecer na aws, vou vendo permition set e plugando com as contas, só ir em identity center, groups, vai aparecer o grupo BR_AWSZPY_IA_DEVELOPER, vou pegar ele, colocar as contas em AWS Accounts