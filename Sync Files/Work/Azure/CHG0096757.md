...
- ⚠️ Algumas variáveis vêm como `< obter no recurso >` (ex.: keys de Foundry/Search) — **eu** gero a partir do próprio recurso; outras a dev passa. Confirmar a divisão com ela.
