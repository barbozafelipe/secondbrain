...
> O João mandou a lista de 22 vars. Gravados **20** (preservando as 6 que já existiam na function). Comando só faz merge: adiciona/atualiza o que está no arquivo e mantém o resto. Total final: **26 settings**.
>
...
>
> **2 erros pegos na lista do João (corrigidos antes de gravar):**
