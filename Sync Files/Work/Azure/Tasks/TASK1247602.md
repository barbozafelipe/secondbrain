...
- [ ] Os nomes dos recursos estão exatamente conforme solicitado? (sem espaços, sem maiúsculas erradas)
- [ ] O Tier do Service Plan está como **B1** nos 3 ambientes?
- [ ] Cada Web App tem seu próprio Service Plan (não compartilhado)?
- [ ] NPROD e HML estão na subscription `DIGITAL-NPROD` e PRD na `DIGITAL-PROD`?
- [ ] O Container Registry de cada ambiente está no RG correto?
