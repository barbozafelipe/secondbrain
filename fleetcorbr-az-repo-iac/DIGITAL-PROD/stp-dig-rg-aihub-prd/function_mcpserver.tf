module "function_mcpserver" {
  ...
  service_plan_name = "spt-dig-asp-mcpserver-01-prd"
  sku_name          = "B1"

  create_application_insights = true
  create_storage_account      = true

  function_name                 = "stp-dig-func-mcpserver-prd"
  application_insights_name     = "stp-dig-appi-mcpserver-prd"
  virtual_network_subnet_id     = data.azurerm_subnet.snet_app.id
  public_network_access_enabled = true
  builtin_logging_enabled       = true

  # Storage Account Settings
  storage_account_name          = "stpdigmcpserverprd"
