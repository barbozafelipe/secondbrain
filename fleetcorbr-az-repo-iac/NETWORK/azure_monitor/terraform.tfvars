...
activity_log_alert = [
  ...
  {
    name        = "plt-net-al-modify-nsg-rules"
  ...
  {
    name        = "plt-net-al-delete-nsg-rules"
  ...
  {
    name        = "plt-net-al-create-policy-assignment"
  ...
  {
    name        = "plt-net-al-delete-policy-assignment"
  ...
  {
    name        = "plt-net-al-update-security-solution"
  ...
  {
    name        = "plt-net-al-delete-security-solution"
  ...
  {
    name        = "plt-net-al-update-security-policy"
  ...
  {
    name        = "plt-net-al-modify-sql-firewall-rule"
  ...
  {
    name        = "plt-net-al-create-update-vm"
  ...
  {
    name        = "plt-net-al-update-storage-account"
  ...
  {
    name        = "plt-net-al-delete-storage-account"
  ...
  {
    name        = "plt-net-al-update-key-vault"
  ...
  {
    name        = "plt-net-al-delete-key-vault"
  ...
  {
    name        = "plt-net-al-rename-sql-database"
  ...
  {
    name        = "plt-net-al-delete-postgresql-database"
  ...
  {
    name        = "plt-net-al-update-postgresql-database"
  ...
  {
    name        = "plt-net-al-create-update-sql-database"
  ...
  {
    name        = "plt-net-al-delete-sql-database"
  ...
  {
    name        = "plt-net-al-delete-load-balancer"
  ...
  {
    name        = "plt-net-al-update-load-balancer"
  ...
  {
    name        = "plt-net-al-delete-mysql-database"
  ...
  {
    name        = "plt-net-al-update-mysql-database"
  ...
  {
    name        = "plt-net-al-update-public-ip"
  ...
  {
    name        = "plt-net-al-delete-public-ip"
