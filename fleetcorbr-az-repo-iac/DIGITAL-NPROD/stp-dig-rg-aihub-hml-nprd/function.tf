module "function_app" {
  ...
  service_plan_name = "spt-dig-asp-mcpserver-01-hml-nprd"
  sku_name          = "B1"

  create_application_insights = true
  create_storage_account      = true

  function_name                 = "stp-dig-func-mcpserver-hml-nprd"
  application_insights_name     = "stp-dig-appi-mcpserver-hml-nprd"
  virtual_network_subnet_id     = data.terraform_remote_state.vnet.outputs.subnet_id[1]
  public_network_access_enabled = true
  builtin_logging_enabled       = true

  # Storage Account Settings
  storage_account_name          = "stpdigmcpserverhmlnprd"
